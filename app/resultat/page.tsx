...
// Définition de la fonction getDescriptionNarration
const getDescriptionNarration = (sommeFinale: number, prenom: string) => {
  switch (sommeFinale) {
    case 1:
      return `Le chemin de vie 1 indique un fort potentiel de leadership pour ${prenom}.`
    case 2:
      return `Le chemin de vie 2 met en avant la coopération et l'harmonie pour ${prenom}.`
    case 3:
      return `Le chemin de vie 3 révèle une créativité et une joie de vivre pour ${prenom}.`
    case 4:
      return `Le chemin de vie 4 souligne le besoin de structure et de stabilité pour ${prenom}.`
    case 5:
      return `Le chemin de vie 5 suggère une soif de liberté et d'aventure pour ${prenom}.`
    case 6:
      return `Le chemin de vie 6 met l'accent sur la responsabilité et le service aux autres pour ${prenom}.`
    case 7:
      return `Le chemin de vie 7 indique une quête de connaissance et de spiritualité pour ${prenom}.`
    case 8:
      return `Le chemin de vie 8 révèle un potentiel de succès matériel et d'influence pour ${prenom}.`
    case 9:
      return `Le chemin de vie 9 suggère une vocation humanitaire et un désir d'aider le monde pour ${prenom}.`
    default:
      return `Le chemin de vie ${sommeFinale} a une signification particulière pour ${prenom}.`
  }
}
